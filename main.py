...
- Token de AudD o ACR en archivo .env (si se usa detección automática)
...
def main() -> int:
    ...
    parser.add_argument("--query", "-q", help="Descargar esta cancion (Ej: 'Artista - Cancion'). Saltea el reconocimiento y usa analisis por FFT.")
    parser.add_argument("--audio", "-a", help="Usar este archivo de audio local. Saltea reconocimiento, YT-DLP y usa analisis por FFT.")
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            if args.audio:
                ...
                # 2. El usuario pidio una cancion especifica, no AudD o ACRCloud
                ...
                # 3. Flujo actual: uso de AudD o ACRCloud para reconocer audio automaticamente
